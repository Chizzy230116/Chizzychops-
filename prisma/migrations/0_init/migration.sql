...
-- IDs are auto-generated by SERIAL (no manual id values needed)
-- Images: local /soup/ /stew/ /food/ /package/ paths
--         Unsplash ONLY for items with no local image file

INSERT INTO "menu_items"
  ("name","price","category","subcat","description","badge","badge_color","note","img_url","img2_url","sort_order","updated_at")
VALUES
